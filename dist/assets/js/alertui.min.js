...
function close(mdl){if(event.target.matches('.altui-modal, .altui-close')){modalBlock(false);mdl.classList.add('alert-close');setTimeout(function(){mdl.classList.remove('show','alert-close');},callTime);}}
