...
btnCancel.focus();proto.dispatchEvent(modal,'click');break;}});dataIn.value=altOpts.defvalue;dataIn.select();break;case'load':var altLoader=document.createElement('div'),altContL=document.createElement('div'),altContB=document.createElement('div');altLoader.classList.add('alertui-loader');altContL.classList.add('alt-content-left');altContB.classList.add('alt-content-body');altContL.appendChild(altLoader);altContB.innerHTML=altOpts.content;altBdy.appendChild(altContL);altBdy.appendChild(altContB);altOpts.opt["modal-close"]=false;this.loadResponse(altOpts.onload,altUi);break;}
altBox.appendChild(altCm);altBox.appendChild(altHd);altBox.appendChild(altBdy);altBox.appendChild(altFt);altUi.appendChild(modal);altUi.appendChild(altBox);if(altOpts.opt["modal-close"]&&altOpts.type==='alert')
