...
function close(mdl){mdl.classList.add('alert-close');setTimeout(function(){mdl.classList.remove('show','alert-close');},callTime);}
function setActions(mdl){var cBt,i;cBt=mdl.getElementsByClassName('altui-close');for(i=0;i<cBt.length;i++){proto.addEvent(cBt[i],'click',function(){close(mdl);});}}
